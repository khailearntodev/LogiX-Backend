...
class InboxEvent(TenantMutableMixin, Base):
    __tablename__ = "inbox_events"
    __table_args__ = (
        UniqueConstraint("consumer_name", "event_id", name="ux_inbox_consumer_event"),
        Index("ix_inbox_tenant_event", "tenant_id", "event_id"),
        Index(
            "ix_inbox_aggregate_version",
            "tenant_id",
            "aggregate_id",
            "aggregate_version",
        ),
